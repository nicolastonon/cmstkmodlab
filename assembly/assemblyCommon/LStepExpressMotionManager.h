...
class LStepExpressMotionManager : public QObject
{
 Q_OBJECT
  ...
  public slots:
    ...
    QQueue<LStepExpressMotion> set_movements_priorities_XYZA(const double x, const double y, const double z, const double a, const bool do_absolute_movements); //FIXME OK?
